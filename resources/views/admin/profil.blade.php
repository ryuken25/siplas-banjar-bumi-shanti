<x-layouts.dashboard :title="'Profil Saya'">
    <x-slot:header>Profil Admin</x-slot:header>
    <x-slot:subheader>Perbarui informasi akun dan kata sandi.</x-slot:subheader>
                ...
                <form method="POST" action="{{ route('admin.profil.update') }}" enctype="multipart/form-data" class="space-y-5">
                    ...
                    <div class="pt-5 border-t border-slate-100">
                        ...
                        <div class="grid sm:grid-cols-2 gap-4">
                            ...
                            <x-input label="Konfirmasi" name="password_confirmation" type="password" />
                        </div>
                    </div>
